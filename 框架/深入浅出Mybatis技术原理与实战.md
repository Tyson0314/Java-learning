...
- [Mybatis简介](#mybatis简介)
    - [传统的JDBC编程](#传统的jdbc编程)
    - [Hibernate与Mybatis](#hibernate与mybatis)
- [Mybatis入门](#mybatis入门)
    - [SqlSessionFactory](#sqlsessionfactory)
    - [SqlSession](#sqlsession)
    - [映射器Mapper](#映射器mapper)
    - [Mybatis组件的生命周期](#mybatis组件的生命周期)
- [配置](#配置)
    - [properties](#properties)
    - [typeAliases](#typealiases)
    - [typeHandler](#typehandler)
        - [自定义typeHandler](#自定义typehandler)
        - [枚举类型typeHandler](#枚举类型typehandler)
            - [自定义枚举类typeHandler](#自定义枚举类typehandler)
...
- [映射器](#映射器)
    - [select元素](#select元素)
        - [自动映射](#自动映射)
        - [传递多个参数](#传递多个参数)
        - [使用resultMap映射结果集](#使用resultmap映射结果集)
    - [insert元素](#insert元素)
        - [主键回填](#主键回填)
            - [自增主键](#自增主键)
            - [非自增主键](#非自增主键)
    - [update和delete元素](#update和delete元素)
    - [sql元素](#sql元素)
    - [resultMap元素](#resultmap元素)
        - [级联](#级联)
            - [association一对一级联](#association一对一级联)
            - [collection一对多级联](#collection一对多级联)
            - [discriminator鉴别器级联](#discriminator鉴别器级联)
            - [延迟加载](#延迟加载)
        - [系统缓存（一级缓存和二级缓存）](#系统缓存（一级缓存和二级缓存）)
- [动态SQL](#动态sql)
    - [if元素](#if元素)
    - [choose元素](#choose元素)
    - [where元素](#where元素)
    ...
    - [foreach元素](#foreach元素)
    - [bind元素](#bind元素)
- [Mybatis-Spring应用](#mybatis-spring应用)
- [实用场景](#实用场景)
    - [批量更新](#批量更新)
    - [存储过程](#存储过程)
        - [in和out参数](#in和out参数)
