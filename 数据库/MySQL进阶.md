...
![](http://img.dabin-coder.cn/image/image-20210821165019147.png)
...
![](http://img.dabin-coder.cn/image/image-20200520234137916.png)

下图是主键索引对应的 B+树结构，每个节点对应磁盘的一页。

![](http://img.dabin-coder.cn/image/image-20200520234200868.png)

对col3 建立一个单列索引，对应的B+树结构：

![](http://img.dabin-coder.cn/image/image-20200520234231001.png)
...
![最左匹配](http://img.dabin-coder.cn/image/image-20210821103313578.png)
...
![](http://img.dabin-coder.cn/image/mysql-clustered-index.png)
...
5. MyISAM不支持聚集索引，InnoDB支持聚集索引。
   ...
   ![myisam-innodb-index](http://img.dabin-coder.cn/image/myisam-innodb-index.png)
...
![](http://img.dabin-coder.cn/image/mvcc-impl.png)
...
![](http://img.dabin-coder.cn/image/current-read.png)
...
![MySQL-archpng](http://img.dabin-coder.cn/image/mysql-archpng.png)
