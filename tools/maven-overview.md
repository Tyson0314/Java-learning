...
![](http://img.topjavaer.cn/image/传递性依赖.png)
...
![](http://img.topjavaer.cn/image/排查依赖.png)
...
![](http://img.topjavaer.cn/image/使用Jboss maven仓库.png)
...
![](http://img.topjavaer.cn/image/maven内置绑定1.png)

![](http://img.topjavaer.cn/image/maven内置绑定2.png)
...
![](http://img.topjavaer.cn/image/maven聚合.png)
...
![](http://img.topjavaer.cn/image/使用import依赖范围导入依赖管理配置.png)
