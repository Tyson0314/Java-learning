...
![](http://img.topjavaer.cn/image/rabbitmq.png)
...
![](http://img.topjavaer.cn/image/rabbitmq-direct.png)

**fanout**

所有发到 fanout 类型交换机的消息都会路由到所有与该交换机绑定的队列上去。fanout 类型转发消息是最快的。

![](http://img.topjavaer.cn/image/rabbitmq-fanout.png)
...
![](http://img.topjavaer.cn/image/rabbitmq-topic.png)
