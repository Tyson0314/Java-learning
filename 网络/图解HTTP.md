...
- [简单的HTTP协议](#简单的http协议)
	...
	- [首部](#首部)
		...
		- [响应首部字段](#响应首部字段)
		- [实体首部字段](#实体首部字段)
		- [Cookie相关的首部](#cookie相关的首部)
	- [请求URI定位资源](#请求uri定位资源)
	- [HTTP方法](#http方法)
	- [持久连接](#持久连接)
	- [Cookie](#cookie)
	- [编码提升传输速率](#编码提升传输速率)
	- [multipart 多部分对象集合](#multipart-多部分对象集合)
	- [范围请求](#范围请求)
	- [内容协商返回最合适的内容](#内容协商返回最合适的内容)
- [状态码](#状态码)
	- [2xx 成功](#2xx-成功)
	- [3xx 重定向](#3xx-重定向)
	- [4xx 客户端错误](#4xx-客户端错误)
...
- [认证机制](#认证机制)
	...
	- [SSL 客户端认证](#ssl-客户端认证)
	- [基于表单认证](#基于表单认证)
- [基于 HTTP 的功能追加协议](#基于-http-的功能追加协议)
	- [WebSocket](#websocket)
	- [Web 服务器管理文件的 WebDAV](#web-服务器管理文件的-webdav)
- [Web 的攻击技术](#web-的攻击技术)
