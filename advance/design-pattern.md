...
![](http://img.topjavaer.cn/image/singleton-class-init.png)
...
![](http://img.topjavaer.cn/image/抽象工厂.png)
...
![](http://img.topjavaer.cn/image/模板方法.jpg)
...
![](http://img.topjavaer.cn/image/策略模式.png)
...
![](http://img.topjavaer.cn/image/适配器对象适配,png)

类适配器通过继承来完成适配。

![](http://img.topjavaer.cn/image/适配器-类继承,png)
