...
![](http://img.topjavaer.cn/image/20220527084528.png)
...
![](http://img.topjavaer.cn/image/B+树索引0.png)
...
![最左前缀](http://img.topjavaer.cn/image/最左前缀.png)
...
![](http://img.topjavaer.cn/image/cover-index.png)
...
![](http://img.topjavaer.cn/image/mvcc9.png)
...
![](http://img.topjavaer.cn/image/mvcc2.png)

2、事务A对该行数据做了修改，将`age`修改为12，效果如下：

![](http://img.topjavaer.cn/image/mvcc7.png)

3、之后事务B也对该行记录做了修改，将`age`修改为8，效果如下：

![](http://img.topjavaer.cn/image/mvcc11.png)
...
![](http://img.topjavaer.cn/image/read_view10.png)
...
![](http://img.topjavaer.cn/image/image-20210922232259664.png)
...
![](http://img.topjavaer.cn/image/幻读1.png)
...
![](http://img.topjavaer.cn/image/垂直划分.png)
...
![](http://img.topjavaer.cn/image/水平划分.png)
